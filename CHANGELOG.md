...
- Fixed "Resize player" effects not resetting properly.
...
- Added "Give Random Painting" effect.
...
- Changed "Spawn Sand Trap" effect to spawn less evil sand and reduced overall size.
