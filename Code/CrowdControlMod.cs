...
public sealed class CrowdControlMod : Mod
{
    ...
    private void AddAllEffects()
    {
        ...
        AddEffect(new GiveItemEffect(GiveItemEffect.GiveItem.Grapple));
        ...
        AddEffect(new GiveItemEffect(GiveItemEffect.GiveItem.Painting));
        AddEffect(new GiveNadirEffect());
        AddEffect(new SpawnPiggyBankEffect());
        AddEffect(new SpawnVoidVaultEffect());
        ...
        AddEffect(new NotTheBeesEffect(45));
    ...
    private void AddAllFeatures()
    {
        ...
        _features.Add(FeatureID.TheSuitedBirdEgg, new TheSuitedBirdEggFeature());
    }
