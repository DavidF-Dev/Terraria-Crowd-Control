    ...
    public override EffectList Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("God-mode", "god_mode_player") {Category = PlayerFolder, Price = 40, Duration = 30, Description = "Temporarily provide the streamer with invulnerablity and infinite mana"},
                ...
                new Effect("Increase spawn rate", "increase_spawn_rate") {Category = PlayerFolder, Price = 60, Duration = 25, Description = "Temporarily increase spawn-rates around the streamer"},
                new Effect("Infinite ammo & mana", "infinite_ammo") {Category = PlayerFolder, Price = 20, Duration = 30, Description = "Temporarily provide the streamer with infinite ammo and increased ranged damage"},
                ...
                new Effect("Force mount", "force_mount") {Category = PlayerFolder, Price = 50, Duration = 25, Description = "Temporarily force the streamer to ride a mount"},
                new Effect("Shoot bombs", "shoot_bombs") {Category = PlayerFolder, Price = 600, Duration = 15, Description = "Temporarily cause the streamer to drop and shoot bombs that are capable of destroying blocks"},
                new Effect("Shoot grenades", "shoot_grenades") {Category = PlayerFolder, Price = 200, Duration = 20, Description = "Temporarily cause the streamer to drop and shoot grenades"},
                new Effect("Drop smoke bombs", "shoot_smoke_bombs") {Category = PlayerFolder, Price = 40, Description = "Drop smoke bombs near the streamer to obscure the area"},
                ...
                new Effect("+ Provide light buffs", "buff_light") {Category = BuffFolder, Price = 10, Duration = 60, Description = "Temporarily give the streamer light-providing buffs"},
                new Effect("+ Help search for treasure", "buff_treasure") {Category = BuffFolder, Price = 10, Duration = 60, Description = "Temporarily give the streamer treasure-seeking buffs"},
                new Effect("+ Boost movement speed", "buff_movement") {Category = BuffFolder, Price = 10, Duration = 60, Description = "Temporarily give the streamer movement buffs"},
                new Effect("+ Provide lava immunity", "buff_obsidian_skin") {Category = BuffFolder, Price = 10, Duration = 60, Description = "Temporarily give the streamer immunity to lava"},
                new Effect("+ Boost mining speed", "buff_mining") {Category = BuffFolder, Price = 10, Duration = 60, Description = "Temporarily give the streamer increased mining speed"},
                new Effect("+ Provide swimming buffs", "buff_swim") {Category = BuffFolder, Price = 10, Duration = 60, Description = "Temporarily give the streamer improved swimming ability"},

                // --- Buff effects (negative)
                new Effect("- Freeze", "buff_freeze") {Category = BuffFolder, Price = 20, Duration = 8, Description = "Temporarily freeze the streamer in place"},
                new Effect("- Set on fire", "buff_fire") {Category = BuffFolder, Price = 30, Duration = 10, Description = "Temporarily set the streamer on fire"},
                new Effect("- Daze", "buff_daze") {Category = BuffFolder, Price = 30, Duration = 20, Description = "Temporarily daze the streamer, reducing their movement capabilities"},
                new Effect("- Levitate", "buff_levitate") {Category = BuffFolder, Price = 30, Duration = 25, Description = "Temporarily cause the streamer to levitate"},
                new Effect("- Confuse", "buff_confuse") {Category = BuffFolder, Price = 30, Duration = 25, Description = "Temporarily reverse the streamer's controls"},
                new Effect("- Make invisible", "buff_invisible") {Category = BuffFolder, Price = 30, Duration = 30, Description = "Temporarily make the streamer invisible"},
                new Effect("- Blind", "buff_blind") {Category = BuffFolder, Price = 30, Duration = 25, Description = "Temporarily decrease the streamer's vision"},
                new Effect("- Curse", "buff_curse") {Category = BuffFolder, Price = 20, Duration = 8, Description = "Temporarily prevent the streamer from using any items"},
                new Effect("- Noclip", "buff_shimmer") {Category = BuffFolder, Price = 20, Duration = 2, Description = "Temporarily cause the streamer to fall through blocks"},
                ...
                new Effect("Shimmer item", "shimmer_item") {Category = InventoryFolder, Price = 250, Description = "Shimmer the streamer's held item if possible"},
                new Effect("Item attractor", "item_pull") {Category = InventoryFolder, Price = 25, Duration = 25, Description = "Temporarily cause nearby items to gravitate towards the player"},
                new Effect("Item repeller", "item_push") {Category = InventoryFolder, Price = 25, Duration = 25, Description = "Temporarily cause nearby items to repel away from the player"},
                ...
                new Effect("Give random painting", "give_painting") {Category = InventoryFolder, Price = 5, Description = "Provide the streamer with a random decorative painting"},
                new Effect("Give \"Zenith\"", "give_nadir") {Category = InventoryFolder, Price = 10, Description = "Provide the streamer with the \"strongest\" weapon in the game, the \"Zenith\""},
                ...
                new Effect("Rainbow feet", "rainbow_feet") {Category = WorldFolder, Price = 20, Duration = 60, Description = "Temporarily cause the streamer to paint rainbows wherever they walk"},
                ...
                new Effect("Rain Golden Slimes", "golden_slime_rain") {Category = WorldFolder, Price = 75, Duration = 60, Description = "Rain Golden Slimes above the streamer, giving them an opportunity to gather coins"},
                ...
                new Effect("\"For the Worthy\" mode (Enable)", "enable_for_the_worthy") {Category = WorldFolder, Inactive = true, Price = 1200, Description = "Enable \"For the Worthy\" mode in the streamer's world"},
                new Effect("\"For the Worthy\" mode (Disable)", "disable_for_the_worthy") {Category = WorldFolder, Inactive = true, Price = 300, Description = "Disable \"For the Worthy\" mode in the streamer's world"},
                new Effect("\"For the Worthy\" mode (Temporary)", "temp_for_the_worthy") {Category = WorldFolder, Inactive = true, Price = 100, Duration = 150, Description = "Temporarily enable \"For the Worthy\" mode in the streamer's world"},
                new Effect("\"Don't Starve\" mode (Enable)", "enable_the_constant") {Category = WorldFolder, Inactive = true, Price = 1000, Description = "Enable \"Don't Starve\" mode in the streamer's world"},
                new Effect("\"Don't Starve\" mode (Disable)", "disable_the_constant") {Category = WorldFolder, Inactive = true, Price = 300, Description = "Disable \"Don't Starve\" mode in the streamer's world"},
                new Effect("\"Don't Starve\" mode (Temporary)", "temp_the_constant") {Category = WorldFolder, Inactive = true, Price = 100, Duration = 150, Description = "Temporarily enable \"Don't Starve\" mode in the streamer's world"},
                new Effect("Switch soundtrack", "switch_soundtrack") {Category = WorldFolder, Price = 10, Description = "Switch between the Vanilla and Otherworld soundtrack"},
                ...
                // --- Screen effects
                new Effect("Flip the screen", "flip_screen") {Category = ScreenFolder, Price = 50, Duration = 25, Description = "Temporarily flip the streamer's screen"},
                new Effect("Drunk mode", "drunk_mode") {Category = ScreenFolder, Price = 50, Duration = 25, Description = "Temporarily cause the screen to become wobbly and distorted"},
                new Effect("Zoom in", "zoom_in") {Category = ScreenFolder, Price = 30, Duration = 25, Description = "Temporarily zoom the screen in"},
                new Effect("Zoom out", "zoom_out") {Category = ScreenFolder, Price = 30, Duration = 25, Description = "Temporarily zoom the screen out"},
                new Effect("Wall of fish", "wall_of_fish") {Category = ScreenFolder, Price = 20, Duration = 25, Description = "Temporarily draw a wall of fish across the streamer's screen"},
                new Effect("Critter takeover", "critter_takeover") {Category = ScreenFolder, Price = 15, Duration = 60, Description = "Temporarily alter NPC textures to look like harmless critters"},
                new Effect("Screen shake", "screen_shake") {Category = ScreenFolder, Price = 50, Duration = 20, Description = "Temporarily shake the streamer's screen"},
                new Effect("Sniper mode", "sniper_mode") {Category = ScreenFolder, Price = 50, Duration= 25, Description = "Temporarily cause the camera to follow the streamer's mouse"},
                new Effect("Monolith (Aether)", "monolith_shimmer") {Category = ScreenFolder, Price = 10, Duration = 30, Description = "Temporarily enable the Aether monolith visual effect"},
                new Effect("Monolith (Void)", "monolith_moon_lord") {Category = ScreenFolder, Price = 10, Duration = 30, Description = "Temporarily enable the Void monolith visual effect"},
...
#if EXPOSE_CHALLENGES
                new Effect("Start \"swim\" challenge", "swim_challenge") {Category = ChallengesFolder, Inactive = true, Price = 20, Duration = 30, Description = "Challenge the streamer to go for a swim"},
                ...
                new Effect("Start \"catch critter\" challenge", "catch_critter_challenge") {Category = ChallengesFolder, Inactive = true, Price = 20, Duration = 30, Description = "Challenge the streamer to catch a nearby critter"},
                ...
                new Effect("Start \"word puzzle\" challenge", "word_puzzle_challenge") {Category = ChallengesFolder, Inactive = true, Price = 20, Duration = 30, Description = "Challenge the streamer to complete a small word puzzle"},
#endif
            };
        }
    }
