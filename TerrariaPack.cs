    ...
    public override List<Effect> Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("Spawn water trap", "water_trap", WorldFolder) {Price = 75, Description = "Fill the streamer's screen with water"},
                new Effect("Spawn honey trap", "honey_trap", WorldFolder) {Price = 100, Description = "Fill the streamer's screen with honey"},
                new Effect("Spawn lava trap", "lava_trap", WorldFolder) {Price = 500, Description = "Fill the streamer's screen with lava"},
