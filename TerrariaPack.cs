    ...
    public override EffectList Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("\"For the Worthy\" mode (Disable)", "disable_for_the_worthy") {Category = WorldFolder, Inactive = true, Price = 400, Description = "Disable \"For the Worthy\" mode in the streamer's world"},
                //new Effect("\"For the Worthy\" mode (Temporary)", "temp_for_the_worthy") {Category = WorldFolder, Price = 100, Duration = 60 * 5, Description = "Temporarily enable \"For the Worthy\" mode in the streamer's world"},
                ...
                new Effect("\"Don't Starve\" mode (Disable)", "disable_the_constant") {Category = WorldFolder, Price = 400, Description = "Disable \"Don't Starve\" mode in the streamer's world"},
                //new Effect("\"Don't Starve\" mode (Temporary)", "temp_the_constant") {Category = WorldFolder, Price = 100, Duration = 60 * 5, Description = "Temporarily enable \"Don't Starve\" mode in the streamer's world"},
