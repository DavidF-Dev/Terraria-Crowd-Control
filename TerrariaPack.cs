    ...
    public override EffectList Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("Start \"catch critter\" challenge", "catch_critter_challenge") {Category = ChallengesFolder, Inactive = true, Price = 20, Duration = 40, Description = "Challenge the streamer to catch a nearby critter"},
