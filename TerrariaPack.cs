    ...
    public override List<Effect> Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("Max health (+1 heart)", "increase_life", PlayerFolder) {Price = 50, Description = "Increase the streamer's max health"},
                new Effect("Max health (-1 heart)", "decrease_life", PlayerFolder) {Price = 100, Description = "Decrease the streamer's max health"},
                new Effect("Max mana (+1 star)", "increase_mana", PlayerFolder) {Price = 50, Description = "Increase the streamer's max mana"},
                new Effect("Max mana (-1 star)", "decrease_mana", PlayerFolder) {Price = 100, Description = "Decrease the streamer's max mana"},
