    ...
    public override List<Effect> Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("Increase knockback", "increase_knockback", PlayerFolder) {Price = 40, Description = "Temporarily increase the knockback received and dealt by the streamer"},
                ...
                new Effect("Give hiccups", "hiccup", PlayerFolder) {Price = 10, Description = "Temporarily give the streamer hiccups, causing them to hop"},
                ...
                new Effect("Switch loadout", "switch_loadout", InventoryFolder) {Price = 15, Description = "Randomly switch the streamer's inventory loadout to a random one"},
