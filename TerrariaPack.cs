    ...
    public override EffectList Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("\"For the Worthy\" mode (Disable)", "disable_for_the_worthy") {Category = WorldFolder, Price = 400, Description = "Disable \"For the Worthy\" mode in the streamer's world"},
