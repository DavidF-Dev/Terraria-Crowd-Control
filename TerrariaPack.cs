    ...
    public override List<Effect> Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                // --- Boss effects
                new Effect("Boss Effects", "boss_folder", ItemKind.Folder),
                new Effect("Spawn a boss", "random_boss"),
                new Effect("Spawn King Slime", "spawn_king_slime"),
                new Effect("Spawn Eye of Cthulhu (Night)", "spawn_eye_of_cthulhu"),
                new Effect("Spawn Eater of Worlds (Corruption)", "spawn_eater_of_worlds"),
                new Effect("Spawn Brain of Cthulhu (Crimson)", "spawn_brain_of_cthulhu"),
                new Effect("Spawn Queen Bee", "spawn_queen_bee"),
                new Effect("Spawn Skeletron (Night)", "spawn_skeletron"),
                new Effect("Spawn Deerclops", "spawn_deerclops"),
                new Effect("Spawn Wall of Flesh (Hell)", "spawn_wall_of_flesh"),
                new Effect("Spawn Queen Slime", "spawn_queen_slime"),
                new Effect("Spawn Twins (Night)", "spawn_twins"),
                new Effect("Spawn Destroyer (Night)", "spawn_destroyer"),
                new Effect("Spawn Skeletron Prime (Night)", "spawn_skeletron_prime"),
                new Effect("Spawn Plantera", "spawn_plantera"),
                new Effect("Spawn Golem", "spawn_golem"),
                new Effect("Spawn Duke Fishron", "spawn_duke_fishron"),
                new Effect("Spawn Empress of Light", "spawn_empress_of_light"),
                new Effect("Spawn Moon Lord", "spawn_moon_lord"),
