    ...
    public override List<Effect> Effects
    {
        get
        {
            return new List<Effect>()
            {
                ...
                new Effect("Explode", "explode_player", PlayerFolder) {Price = 1750, Description = "Explode the streamer"},
                new Effect("Heal", "heal_player", PlayerFolder) {Price = 40, Description = "Fully heal the streamer"},
                new Effect("Damage", "damage_player", PlayerFolder) {Price = 200, Description = "Severely damage the streamer"},
                ...
                new Effect("Max health (+1 heart)", "increase_life", PlayerFolder) {Price = 25, Description = "Increase the streamer's max health"},
                new Effect("Max health (-1 heart)", "decrease_life", PlayerFolder) {Price = 75, Description = "Decrease the streamer's max health"},
                new Effect("Max mana (+1 star)", "increase_mana", PlayerFolder) {Price = 25, Description = "Increase the streamer's max mana"},
                new Effect("Max mana (-1 star)", "decrease_mana", PlayerFolder) {Price = 75, Description = "Decrease the streamer's max mana"},
                new Effect("Increase spawn rate", "increase_spawn_rate", PlayerFolder) {Price = 60, Description = "Temporarily increase enemy spawn-rates around the streamer"},
                ...
                new Effect("Shoot bombs", "shoot_bombs", PlayerFolder) {Price = 600, Description = "Temporarily cause the streamer to drop and shoot bombs"},
                new Effect("Shoot grenades", "shoot_grenades", PlayerFolder) {Price = 200, Description = "Temporarily cause the streamer to drop grenades"},
                new Effect("Increase jump height", "jump_boost", PlayerFolder) {Price = 40, Description = "Temporarily increase the streamer's jump height"},
                new Effect("Increase movement speed", "run_boost", PlayerFolder) {Price = 40, Description = "Temporarily increase the streamer's movement speed"},
                ...
                new Effect("Fling upwards", "fling_upwards", PlayerFolder) {Price = 30, Description = "Fling the streamer upwards violently"},
                ...
                new Effect("+ Provide light buffs", "buff_light", BuffFolder) {Price = 10, Description = "Temporarily give the streamer light buffs"},
                ...
                new Effect("- Daze", "buff_daze", BuffFolder) {Price = 30, Description = "Temporarily daze the streamer"},
                ...
                new Effect("Explode inventory", "explode_inventory", InventoryFolder) {Price = 100, Description = "Explode the streamer's inventory"},
                ...
                new Effect("Reforge item", "item_prefix", InventoryFolder) {Price = 5, Description = "Reforge the streamer's held weapon"},
                ...
                new Effect("Give pickaxe", "give_pickaxe", InventoryFolder) {Price = 25, Description = "Provide the streamer with a pickaxe"},
                new Effect("Give sword", "give_sword", InventoryFolder) {Price = 25, Description = "Provide the streamer with a sword"},
                new Effect("Give armour", "give_armour", InventoryFolder) {Price = 25, Description = "Provide the streamer with an armour piece"},
                new Effect("Give healing potion", "give_healing_potion", InventoryFolder) {Price = 5, Description = "Provide the streamer with a healing potion"},
                new Effect("Give random potion", "give_potion", InventoryFolder) {Price = 10, Description = "Provide the streamer with a random potion"},
                new Effect("Give food", "give_food", InventoryFolder) {Price = 5, Description = "Provide the streamer with some food"},
                new Effect("Give random kite", "give_kite", InventoryFolder) {Price = 5, Description = "Provide the streamer with a kite"},
                ...
                new Effect("Spawn structure", "spawn_structure", WorldFolder) {Price = 100, Description = "Spawn a structure around the streamer"},
                ...
                new Effect("Spawn lava trap", "lava_trap", WorldFolder) {Price = 750, Description = "Spawn a large pool of lav"},
                new Effect("Random teleport", "random_teleport", WorldFolder) {Price = 150, Description = "Randomly teleport the streamer"},
                ...
                new Effect("Rain Golden Slimes", "golden_slime_rain", WorldFolder) {Price = 75, Description = "Rain Golden Slimes above the streamer"},
                ...
                new Effect("Mystery blocks", "mystery_blocks", WorldFolder) {Price = 25, Description = "Temporarily hide the blocks on screen"},

                // --- Boss effects
                new Effect("Boss effects", BossFolder, ItemKind.Folder),
                new Effect("Spawn a boss", "random_boss", BossFolder) {Price = 500, Description = "Spawn a random boss on the streamer"},
                new Effect("Spawn King Slime", "spawn_king_slime", BossFolder) {Price = 1000, Description = "Spawn King Slime on the streamer"},
                new Effect("Spawn Eye of Cthulhu (Night)", "spawn_eye_of_cthulhu", BossFolder) {Price = 1000, Description = "Spawn Eye of Cthulhu on the streamer"},
                new Effect("Spawn Eater of Worlds (Corruption)", "spawn_eater_of_worlds", BossFolder) {Price = 1000, Description = "Spawn Eater of Worlds on the streamer"},
                new Effect("Spawn Brain of Cthulhu (Crimson)", "spawn_brain_of_cthulhu", BossFolder) {Price = 1000, Description = "Spawn Brain of Cthulhu on the streamer"},
                new Effect("Spawn Queen Bee", "spawn_queen_bee", BossFolder) {Price = 1000, Description = "Spawn Queen Bee on the streamer"},
                new Effect("Spawn Skeletron (Night)", "spawn_skeletron", BossFolder) {Price = 1000, Description = "Spawn Skeletron on the streamer"},
                new Effect("Spawn Deerclops", "spawn_deerclops", BossFolder) {Price = 1000, Description = "Spawn Deerclops on the streamer"},
                new Effect("Spawn Wall of Flesh (Hell)", "spawn_wall_of_flesh", BossFolder) {Price = 1000, Description = "Spawn Wall of Flesh on the streamer"},
                new Effect("Spawn Queen Slime", "spawn_queen_slime", BossFolder) {Price = 1000, Description = "Spawn Queen Slime on the streamer"},
                new Effect("Spawn Twins (Night)", "spawn_twins", BossFolder) {Price = 1000, Description = "Spawn The Twins on the streamer"},
                new Effect("Spawn Destroyer (Night)", "spawn_destroyer", BossFolder) {Price = 1000, Description = "Spawn The Destroyer on the streamer"},
                new Effect("Spawn Skeletron Prime (Night)", "spawn_skeletron_prime", BossFolder) {Price = 1000, Description = "Spawn Skeletron Prime on the streamer"},
                ...
                new Effect("Drunk mode", "drunk_mode", ScreenFolder) {Price = 50, Description = "Temporarily cause the screen to become wobbly"},
                ...
                new Effect("Critter takeover", "critter_takeover", ScreenFolder) {Price = 15, Description = "Temporarily draw critters instead of normal NPCs"},
                ...
                new Effect("Do-or-die challenge", "random_challenge",
                    ...
                    PlayerFolder
#endif
                    ) {Price = 20, Description = "Issue a timed challenge to the streamer which they must complete, or they will die"},
#if EXPOSE_CHALLENGES
